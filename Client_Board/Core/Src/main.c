...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, RFID_SDA_Pin|RFID_RST_Pin|GPIO_PIN_5|RGB_R_Pin
                          |RGB_G_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : KEY_0_Pin KEY_1_Pin KEY_2_Pin KEY_3_Pin
                           ...
                           KEY_8_Pin KEY_9_Pin KEY_DELETE_Pin KEY_ENTER_Pin
                           KEY_CLOSE_Pin */
  ...
  /*Configure GPIO pins : RFID_SDA_Pin RFID_RST_Pin PA5 RGB_R_Pin
                           RGB_G_Pin */
  GPIO_InitStruct.Pin = RFID_SDA_Pin|RFID_RST_Pin|GPIO_PIN_5|RGB_R_Pin
                          |RGB_G_Pin;
