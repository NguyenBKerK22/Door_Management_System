...
#define RFID_SDA_Pin GPIO_PIN_0
#define RFID_SDA_GPIO_Port GPIOA
#define RFID_RST_Pin GPIO_PIN_1
...
#define KEY_DELETE_Pin GPIO_PIN_10
#define KEY_DELETE_GPIO_Port GPIOC
#define KEY_ENTER_Pin GPIO_PIN_11
#define KEY_ENTER_GPIO_Port GPIOC
#define KEY_CLOSE_Pin GPIO_PIN_12
